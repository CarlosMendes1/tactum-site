...
// Preço "antes" (~25% acima, terminado em .90) para mostrar riscado.
export const compareAtPrice = (price) => Math.round(price / 0.75) - 0.1;

// Percentagem de desconto entre o preço "antes" e o atual (inteiro).
export const discountPct = (price, was) => Math.round((1 - price / was) * 100);
